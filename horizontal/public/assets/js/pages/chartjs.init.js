  ...
  ChartJs.prototype.initCharts = function () {
    ...
    if ($('#pie-chart-example').length > 0) {
      ...
      var pieChart = {
        ...
        datasets: [{
          data: [300, 135, 48, 154],
          backgroundColor: ["#4a81d4", "#f672a7", "#e3eaef", "#f0643b"],
    ...
    if ($('#donut-chart-example').length > 0) {
      ...
      var donutChart = {
        ...
        datasets: [{
          data: [128, 78, 48],
          backgroundColor: ["#ebeff2", "#56c2d6", "#f0643b"],
          borderColor: "transparent",
          borderWidth: "3"
        }]
      };
    ...
    if ($('#polar-chart-example').length > 0) {
      ...
      var polarChart = {
        ...
        datasets: [{
          data: [251, 135, 48, 154],
          backgroundColor: ["#4a81d4", "#ebeff2", "#56c2d6", "#f0643b"],
          borderColor: "transparent"
        }]
      };
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\xeria-laravel-horizontal\resources\js\pages\chartjs.init.js */"./resources/js/pages/chartjs.init.js");
