...
@section('css')
        <!-- Tour css -->
        <link href="{{ URL::asset('assets/libs/hopscotch/hopscotch.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        <!-- Tour page js -->
        <script src="{{ URL::asset('assets/libs/hopscotch/hopscotch.min.js')}}"></script>
