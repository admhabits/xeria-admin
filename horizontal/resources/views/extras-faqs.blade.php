                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center">
                                    ...
                                    <button type="button" class="btn btn-danger waves-effect waves-light mt-2 mr-1"><i class="mdi mdi-email-outline mr-1"></i> Email us your question</button>
                                    <button type="button" class="btn btn-info waves-effect waves-light mt-2"><i class="mdi mdi-twitter mr-1"></i> Send us a tweet</button>
