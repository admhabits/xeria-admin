...
@section('content')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <h1 class="mt-4">Example heading <span class="badge badge-secondary">New</span></h1>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <h1 class="mt-4">Example heading <span class="badge badge-secondary badge-pill">New</span></h1>
                                    <h2>Example heading <span class="badge badge-secondary badge-pill">New</span></h2>
                                    <h3>Example heading <span class="badge badge-secondary badge-pill">New</span></h3>
                                    <h4>Example heading <span class="badge badge-secondary badge-pill">New</span></h4>
                                    <h5>Example heading <span class="badge badge-secondary badge-pill">New</span></h5>
                                    <h6>Example heading <span class="badge badge-secondary badge-pill">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title">Badges Lighten</h4>
                                    <p class="text-muted mb-3">
                                        Badges scale to match the size of the immediate parent element by using relative font sizing and <code>em</code> units.
                                    </p>
                                    ...
                                    <span class="badge badge-light-pink">Pink</span>
                                    <span class="badge badge-light-purple">Purple</span>
                                    <span class="badge badge-light-dark">Dark</span>

                                    <h1 class="mt-4">Example heading <span class="badge badge-light-secondary">New</span></h1>
                                    <h2>Example heading <span class="badge badge-light-secondary">New</span></h2>
                                    <h3>Example heading <span class="badge badge-light-secondary">New</span></h3>
                                    <h4>Example heading <span class="badge badge-light-secondary">New</span></h4>
                                    <h5>Example heading <span class="badge badge-light-secondary">New</span></h5>
                                    <h6>Example heading <span class="badge badge-light-secondary">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <span class="badge badge-light-primary badge-pill">Primary</span>
                                    <span class="badge badge-light-secondary badge-pill">Secondary</span>
                                    <span class="badge badge-light-success badge-pill">Success</span>
                                    <span class="badge badge-light-danger badge-pill">Danger</span>
                                    <span class="badge badge-light-warning badge-pill">Warning</span>
                                    <span class="badge badge-light-info badge-pill">Info</span>
                                    <span class="badge badge-light-light badge-pill">Light</span>
                                    <span class="badge badge-light-dark badge-pill">Dark</span>
                                    <span class="badge badge-light-pink badge-pill">Pink</span>
                                    <span class="badge badge-light-purple badge-pill">Purple</span>

                                    <h1 class="mt-4">Example heading <span class="badge badge-light-secondary badge-pill">New</span></h1>
                                    <h2>Example heading <span class="badge badge-light-secondary badge-pill">New</span></h2>
                                    <h3>Example heading <span class="badge badge-light-secondary badge-pill">New</span></h3>
                                    <h4>Example heading <span class="badge badge-light-secondary badge-pill">New</span></h4>
                                    <h5>Example heading <span class="badge badge-light-secondary badge-pill">New</span></h5>
                                    <h6>Example heading <span class="badge badge-light-secondary badge-pill">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                        </div>
                        <!-- end row -->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-1 font-weight-medium mt-4">Rounded Pagination</p>
                                                <p class="text-muted">
                                                ...
                                                <p class="mb-1 font-weight-medium mt-4">Sizing</p>
                                                <p class="text-muted">
                                                    Add <code>
                                                    .pagination-lg</code>
                                                    or <code>
                                                ...
                                                <p class="mb-1 font-weight-medium mt-4">Alignment</p>
                                                <p class="text-muted">
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    <div class="row">
                                        ...
                                        <!-- Badges -->
                                        <div class="col-lg-6">
                                            <h4 class="m-t-0 header-title">Border Spinner</h4>
                                            <p class="sub-header">
                                            ...
                                            <h4 class="mt-5 header-title">Alignment</h4>
                                            <p class="sub-header">Use flexbox utilities, float utilities, or text alignment utilities to place spinners exactly
                                            ...
                                            <h4 class="mt-5 header-title">Size</h4>
                                        ...
                                        <div class="col-lg-6 mt-5 mt-lg-0">
                                            ...
                                            <h4 class="mt-5 header-title">Placement</h4>
                                            ...
                                            <h4 class="mt-5 header-title">Buttons spinner</h4>
