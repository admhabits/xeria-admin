                            ...
                            <div class="col-12">
                                <div class="timeline" dir="ltr">
                                    ...
                                    <article class="timeline-item">
                                        <h2 class="m-0 d-none">&nbsp;</h2>
                                        <div class="time-show">
                                            <a href="#" class="btn btn-danger width-lg">Yesterday</a>
                                        </div>
                                    </article>
                                    ...
                                    <article class="timeline-item">
                                        <h2 class="m-0 d-none">&nbsp;</h2>
                                        <div class="time-show">
                                            <a href="#" class="btn btn-info width-lg">Last Month</a>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                    <h4 class="mt-0 font-16">31 December 2018</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
                                                    <p class="mb-0">Download the new updates of Ubold admin dashboard</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                    <h4 class="mt-0 font-16">16 Decembar 2018</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
