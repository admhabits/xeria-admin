...
/***/ "./resources/js/pages/britechart.init.js":
/*!***********************************************!*\
  !*** ./resources/js/pages/britechart.init.js ***!
  \***********************************************/
...
(function ($, context) {
  ...
  context.createBarChart = function (elementSelector, data) {
    ...
    _barChart.isAnimated(true).width(containerWidth).height(containerHeight).margin(margin).betweenBarsPadding(0.5).colorSchema(["#56c2d6"]).on("customMouseOver", chartTooltip.show).on("customMouseMove", chartTooltip.update).on("customMouseOut", chartTooltip.hide);
  ...
  context.createHorizontalBarChart = function (elementSelector, data) {
    ...
    _barChart.colorSchema(['#4a81d4', '#f672a7', '#e3eaef', '#f0643b', '#56c2d6', "#675db7", "#f8cc6b"]).isAnimated(true).isHorizontal(true).width(containerWidth).margin(margin).enableLabels(true).percentageAxisToMaxRatio(1.3).labelsNumberFormat(1).height(containerHeight);
  ...
  context.createDonutChart = function (elementSelector, data) {
    ...
    legendChart.width(250).height(200).colorSchema(['#4a81d4', '#f672a7', '#e3eaef', '#f0643b', '#56c2d6', "#f8cc6b"]).numberFormat("s");
    donutChart.height(300).highlightSliceById(3).colorSchema(['#4a81d4', '#f672a7', '#e3eaef', '#f0643b', '#56c2d6', "#f8cc6b"]).hasFixedHighlightedSlice(true).internalRadius(80).on('customMouseOver', function (data) {
...
/***/ 35:
/*!*****************************************************!*\
  !*** multi ./resources/js/pages/britechart.init.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\xeria-laravel-horizontal\resources\js\pages\britechart.init.js */"./resources/js/pages/britechart.init.js");
