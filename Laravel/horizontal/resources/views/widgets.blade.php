                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title mt-0 mb-2">Total Revenue</h4>
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="text-right">
                                            <h2 class="mt-3 pt-1 mb-1"> 256 </h2>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="text-right">
                                            <h2 class="mt-3 pt-1 mb-1"> 3541 </h2>
                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card cta-box">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <div class="avatar-md bg-danger rounded-circle text-center mb-2">
                                                    <i class="mdi mdi-bullhorn-outline font-22 avatar-title text-light"></i>
                                                </div>
                                                <h3 class="font-weight-normal cta-box-title">Enhance your <b>Campaign</b> for better outreach</h3>
                                            
                                                <a href="javascript: void(0);" class="text-danger font-weight-semibold text-uppercase">Read More <i class="mdi mdi-arrow-right"></i></a>
                                            </div>
                                            <img class="ml-3" src="assets/images/maker-launch.svg" width="120" alt="Generic placeholder image">
                                        </div>
                                    </div>
                                </div>
                            </div>
