                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-pricing">
                                            <div class="card-body text-center">
                                                ...
                                                <button class="btn btn-danger waves-effect waves-light mt-4 mb-2 width-sm">Sign Up</button>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-pricing card-pricing-recommended">
                                            <div class="card-body text-center">
                                                ...
                                                <button class="btn btn-info waves-effect waves-light mt-4 mb-2 width-sm">Sign Up</button>
                                            </div>
                                        </div> <!-- end Pricing_card -->
                                    </div> <!-- end col -->
