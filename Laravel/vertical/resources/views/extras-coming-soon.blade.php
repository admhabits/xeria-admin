...
<html lang="en">
    ...
    <body class="authentication-bg">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <h2>
                                <a href="index">
                                    <img src="assets/images/logo-dark.png" alt="main-logo" height="18" />
                                </a>
                            </h2>

                            <img src="assets/images/maker-launch.svg" width="180" class="mt-4" alt="error-image"/>
        ...
        <footer class="footer footer-alt">
            {{date('Y')}} &copy; Xeria theme by <a href="" class="text-body">Coderthemes</a> 
        </footer>
